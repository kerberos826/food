    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                    ...
                    color="deep-purple lighten-2"
                    text
                    @click="openAcceptOrDecline"
            >
                AcceptOrDecline
            </v-btn>
            <v-dialog v-model="acceptOrDeclineDiagram" width="500">
                <AcceptOrDeclineCommand
                        @closeDialog="closeAcceptOrDecline"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            openAcceptOrDecline() {
                this.acceptOrDeclineDiagram = true;
            },
            closeAcceptOrDecline() {
                this.acceptOrDeclineDiagram = false;
            },
            async startCooking() {
                try {
                    if(!this.offline) {
